...
J. Logajan note: AppShell.py in turn was obtained from John E. Grayson's
'Python and Tkinter Programming' site http://www.manning.com/grayson
...
class AppShell(Pmw.MegaWidget):        
    ...
    def initializeTk(self, root):
        for fn in ["optionDB", "optionDB.txt", "optionDB_sample"]:
            if os.path.exists(fn):
                root.option_readfile(fn)
                break
    ...
    def toggleBalloon(self):
        ...
        self.cache.ballonState = self.__balloon.cget("state")
        self.WriteCache()
    ...
    def __createMenuBar(self):
        ...
        self.menuBar.addmenu('Session', 'Login/logout commands and Quit')
